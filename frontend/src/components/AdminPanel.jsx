...
function AdminPanel() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        const response = await axios.get(
          `https://mern-pxsj.onrender.com/api/admin/appointments?status=${filter === 'all' ? '' : filter}`
        );
    ...
    const eventSource = new EventSource('https://mern-pxsj.onrender.com/api/admin/updates');
  ...
  const confirmAppointment = async (id) => {
    try {
      ...
      const response = await axios.patch(
        `https://mern-pxsj.onrender.com/api/admin/appointments/${id}`,
        { status: 'Confirmed' }
      );
  ...
  const cancelAppointment = async (id) => {
    ...
    try {
      setIsLoading(true);
      await axios.delete(`https://mern-pxsj.onrender.com/api/admin/appointments/${id}`);
